...
require("~/themes/starter/assets/vendor/magnific-popup/jquery.magnific-popup.js"); // Require vendor jQuery plugin (not module)
...
$(document).ready(function () {
  ...
  $("#open-popup").magnificPopup({
    items: [
      {
        src: "/themes/starter/assets/images/b1.jpg",
        title:
