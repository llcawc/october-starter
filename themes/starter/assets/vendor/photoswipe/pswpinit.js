...
// 4. Реализация: Эта функция ниже загружает код и инициализирует плагин обязательно указать размеры фото
//    в теге <a>: data-size="1920x1200" просто добавь класс '.pswpgall' в обёртку тега 'figure' где внутри 'img'
//    пописи к фото берутся из тега <figcaption> галерея с пролистованием работает при не менее 3-х картинок
//    код на страницу вставляется автоматом перед закрывающим body.
// ------------------------------------------------------------------------------------------------------------------------
