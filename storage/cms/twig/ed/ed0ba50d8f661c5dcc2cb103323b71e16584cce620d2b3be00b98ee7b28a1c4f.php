...
$context["post"], "published_at", [], "any", false, false, true, 17), 17, $this->source), " Y"), "html", null, true);
    ...
    <div class=\"col-sm-12 py-5\">
      ";
        // line 39
        if ((twig_get_attribute($this->env, $this->source, ($context["posts"] ?? null), "lastPage", [], "any", false, false, true, 39) > 1)) {
            // line 40
            echo "      <ul class=\"pagination mb-0\">
        ";
            // line 41
            if ((twig_get_attribute($this->env, $this->source, ($context["posts"] ?? null), "currentPage", [], "any", false, false, true, 41) > 1)) {
                // line 42
                echo "        <li><a href=\"";
                echo $this->extensions['Cms\Twig\Extension']->pageFilter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 42), "baseFileName", [], "any", false, false, true, 42), 42, $this->source), [twig_get_attribute($this->env, $this->source, ($context["blogPosts"] ?? null), "pageParam", [], "any", false, false, true, 42) => (twig_get_attribute($this->env, $this->source, ($context["posts"] ?? null), "currentPage", [], "any", false, false, true, 42) - 1)]);
                echo "\">&larr; Prev</a>
        </li>
        ";
            }
        ...
        ";
            // line 46
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(range(1, twig_get_attribute($this->env, $this->source, ($context["posts"] ?? null), "lastPage", [], "any", false, false, true, 46)));
            foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
                // line 47
                echo "        <li class=\"";
                echo (((twig_get_attribute($this->env, $this->source, ($context["posts"] ?? null), "currentPage", [], "any", false, false, true, 47) == $context["page"])) ? ("active") : (null));
                echo "\">
          <a href=\"";
                // line 48
                echo $this->extensions['Cms\Twig\Extension']->pageFilter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 48), "baseFileName", [], "any", false, false, true, 48), 48, $this->source), [twig_get_attribute($this->env, $this->source, ($context["blogPosts"] ?? null), "pageParam", [], "any", false, false, true, 48) => $context["page"]]);
                echo "\">";
        ...
        ";
            // line 52
            if ((twig_get_attribute($this->env, $this->source, ($context["posts"] ?? null), "lastPage", [], "any", false, false, true, 52) > twig_get_attribute($this->env, $this->source, ($context["posts"] ?? null), "currentPage", [], "any", false, false, true, 52))) {
                // line 53
                echo "        <li><a href=\"";
                echo $this->extensions['Cms\Twig\Extension']->pageFilter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 53), "baseFileName", [], "any", false, false, true, 53), 53, $this->source), [twig_get_attribute($this->env, $this->source, ($context["blogPosts"] ?? null), "pageParam", [], "any", false, false, true, 53) => (twig_get_attribute($this->env, $this->source, ($context["posts"] ?? null), "currentPage", [], "any", false, false, true, 53) + 1)]);
                echo "\">Next &rarr;</a>
        </li>
        ";
            }
    ...
    {
        return array (  178 => 58,  174 => 56,  167 => 53,  165 => 52,  162 => 51,  151 => 48,  146 => 47,  142 => 46,  139 => 45,  132 => 42,  130 => 41,  127 => 40,  125 => 39,  120 => 36,  111 => 33,  108 => 32,  98 => 27,  94 => 26,  87 => 23,  85 => 22,  79 => 19,  74 => 17,  72 => 16,  70 => 15,  68 => 14,  59 => 10,  56 => 9,  51 => 8,  45 => 4,  43 => 3,  41 => 2,  39 => 1,);
    }
...
<main class=\"container-md\">
  <div class=\"row\">
    ...
    {
        static $tags = array("set" => 1, "for" => 8, "if" => 39);
        static $filters = array("escape" => 10, "date" => 14, "join" => 22, "map" => 22, "raw" => 23, "page" => 42);
        static $functions = array("range" => 46);
