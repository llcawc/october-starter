...
($context["post"] ?? null), "published_at", [], "any", false, false, true, 17), 17, $this->source), " Y"), "html", null, true);
      ...
      ";
        ...
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["post"] ?? null), "featured_images", [], "any", false, false, true, 33), "count", [], "any", false, false, true, 33)) {
            // line 34
            echo "      <div class=\"gallery popup-gallery\">
        ";
            // line 35
            $context['_parent'] = $context;
          ...
          <a href=\"";
                ...
                echo "\" title=\"";
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["image"], "description", [], "any", false, false, true, 37), 37, $this->source), "html", null, true);
                echo "\">
            <img data-src=\"";
                // line 38
                ...
                echo "\" alt=\"";
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["image"], "description", [], "any", false, false, true, 38), 38, $this->source), "html", null, true);
                echo "\" />
          </a>
        </figure>
        ";
  ...
  <div class=\"row\">
    ...
    <div class=\"col-6 text-start\">
      ";
        ...
        if (($context["prevPost"] ?? null)) {
            // line 52
            echo "      <a href=\"";
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["prevPost"] ?? null), "url", [], "any", false, false, true, 52), 52, $this->source), "html", null, true);
            echo "\"><i class=\"bi bi-arrow-left\"></i><br><span><strong>Предыдущий пост:</strong></span><br>\"";
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["prevPost"] ?? null), "title", [], "any", false, false, true, 52), 52, $this->source), "html", null, true);
            echo "\"</a>
      ";
        }
        // line 54
    ...
    <div class=\"col-6 text-end\">
      ";
        ...
        if (($context["nextPost"] ?? null)) {
            // line 58
            echo "      <a href=\"";
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["nextPost"] ?? null), "url", [], "any", false, false, true, 58), 58, $this->source), "html", null, true);
            echo "\"><i class=\"bi bi-arrow-right\"></i><br><span><strong>Следующий пост:</strong></span><br>\"";
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["nextPost"] ?? null), "title", [], "any", false, false, true, 58), 58, $this->source), "html", null, true);
            echo "\"</a>
      ";
        }
        // line 60
    ...
    {
        return array (  203 => 60,  195 => 58,  193 => 57,  188 => 54,  180 => 52,  178 => 51,  169 => 44,  165 => 42,  151 => 38,  145 => 37,  142 => 36,  138 => 35,  135 => 34,  133 => 33,  128 => 31,  122 => 27,  108 => 26,  99 => 25,  82 => 24,  75 => 22,  68 => 18,  64 => 17,  62 => 16,  60 => 15,  58 => 14,  47 => 5,  45 => 4,  43 => 3,  41 => 2,  39 => 1,);
    }
