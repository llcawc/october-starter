    ...
    var requestOptions = {
      ...
      complete: function (data, textStatus, jqXHR) {
        ...
        options.evalComplete &&
          eval(
            '(function($el, context, data, textStatus, jqXHR) {' + options.evalComplete + '}.call($el.get(0), $el, context, data, textStatus, jqXHR))'
          )
      },
      ...
      handleValidationMessage: function (message, fields) {
        ...
        $.each(fields, function focusErrorField(fieldName, fieldMessages) {
          ...
          var fieldElement = $form
            .find('[name="' + fieldName + '"], [name="' + fieldName + '[]"], [name$="[' + fieldName + ']"], [name$="[' + fieldName + '][]"]')
            .filter(':enabled')
            .first()
